...
<div class="container mt-3">
    <form action="/product" method="post" enctype="application/x-www-form-urlencoded">
        <div class="mb-3 mt-3">
            ...
            <input type="text" class="form-control" id="name" value="바나나" name="name">
        </div>
        <div class="mb-3">
            <label for="price" class="form-label">상품 가격</label>
            <input type="number" class="form-control" id="price" value="2000" name="price">
        </div>
        <div class="mb-3">
            <label for="qty" class="form-label">상품 재고</label>
            <input type="number" class="form-control" id="qty" value="50" name="qty">
        </div>
